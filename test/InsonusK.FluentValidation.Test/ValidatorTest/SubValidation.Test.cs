...
/// </summary>
public class SubValidation_Test : ExpectationsTestBase
{

  public SubValidation_Test(ITestOutputHelper output, LogLevel logLevel = LogLevel.Debug) : base(output, logLevel)
  {
  ...
  public class ParentValidator : AbstractValidator<ParentClass>
  {
    ...
    {
      RuleFor(e => e.FieldLen3).Length(1, 3).WithMessage("Len must be from 1 to 3");
